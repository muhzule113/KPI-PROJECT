                ...
                <div className="mx-auto max-w-[1440px] space-y-6">
                    <div className="flex flex-wrap items-start justify-between gap-4">
                        <div>
                            ...
                            <p className="mt-1 text-sm text-muted-foreground">Lihat hasil KPI harian. Nilai ditentukan sistem, Supervisor, atau Manager.</p>
                        </div>
                        <div className="flex items-center gap-2 rounded-xl border border-border/70 bg-card px-3 py-2">
                            ...
                            <Input id="daily-date" type="date" value={date} onChange={changeDate} className="w-auto" />
                        </div>
                    </div>
                        ...
                        <>
                            ...
                            <Card className="overflow-hidden">
                                <CardHeader className="border-b border-border/70">
                                    ...
                                    <CardDescription>Indikator otomatis dihitung sistem; indikator observasi dinilai Supervisor/Manager.</CardDescription>
                                </CardHeader>
